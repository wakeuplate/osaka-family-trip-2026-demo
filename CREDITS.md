...
## Icons and decorative artwork

The app icon and decorative artwork are retained as project assets for this Demo. They are not covered by the source-code MIT license unless a separate source record states otherwise.
